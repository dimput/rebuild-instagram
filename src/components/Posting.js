...
export class Posting extends Component {
    ...
    onDoubleClick = () => {
        ...
        this.timerLove = setInterval(() => this.tick(), 1500)
    }
    ...
    handleDoubleClickPhone = (e) => {
        if (this.lastClick && e.timeStamp - this.lastClick < 250 && this.watingClick) {
            this.lastClick = 0
        ...
        return (
            <div className="posting">
                <div className="posting-title">
                    ...
                    <div className="posting-more" onClick={() => this.toggleMore()}>
                        ...
                    </div>
                    {isShowMore && (
                        <div className="posting-more-dropdown">
                            <div
                                className="posting-more-dropdown-item"
                                onClick={() => handleShowEditCaption(caption, keyPosting)}
                            >
                                Edit Caption
                            </div>
                            <div
                                className="posting-more-dropdown-item"
                                onClick={() => handleDelete(this.props.keyPosting)}
                            >
                                Hapus
                            </div>
                        </div>
                ...
                <div className="posting-button">
                    <svg
                        ...
                        aria-label="Suka"
                        className="_8-yf5 "
                        fill={this.state.colorLove}
                        height="24"
                        viewBox="0 0 48 48"
                        width="24"
                    >
                        <path d={this.state.loveIcon}></path>
                    </svg>
                    <svg
                ...
                {likes > 2 ? (
                    <div className="posting-all-comment">View all 4,890 comments</div>
                ) : null}
                <div className="posting-timepost">{timePost}</div>
            </div>
        )
    }
}
